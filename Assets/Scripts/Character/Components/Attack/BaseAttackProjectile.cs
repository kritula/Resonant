    ...
    public class BaseAttackProjectile : MonoBehaviour
    {
            ...
            AttackStats attackStats)
        {
            ...
            PlayerWeaponData weaponData =
                owner.CharacterData.WeaponData as PlayerWeaponData;

            if (weaponData == null)
                return;

            _baseDamage = attackStats.Damage;
        ...
        private void UpdateDirection()
        {
            ...
            Vector3 dir =
                _homingTarget.transform.position - transform.position;
        ...
        private float CalculateDamage()
        {
            ...
            if (_shotData.PierceBonusAfterFirstPierce &&
                _piercedTargetsCount >= 1)
            {
                damage *= _shotData.PierceBonusMultiplierAfterFirstPierce;
            }

            if (_shotData.PierceDamageFalloff &&
                _piercedTargetsCount > 0)
            {
                float multiplier =
                    1f -
                    (_shotData.PierceDamageFalloffPerTarget *
                     _piercedTargetsCount);
        ...
        private void TrySpawnRicochetProjectile(Character hitTarget)
        {
            ...
            Vector3 directionToTarget =
                nextTarget.transform.position - startPosition;
            ...
            float damageMultiplier =
                _shotData.RicochetNoDamageFalloff
                    ? 1f
                    : _shotData.RicochetDamageMultiplier;
        ...
        private Character FindRicochetTarget(Character hitTarget)
        {
            ...
            float bestDist =
                _shotData.RicochetSearchRadius *
                _shotData.RicochetSearchRadius;
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ...
                float dist =
                    (c.transform.position -
                     hitTarget.transform.position).sqrMagnitude;
