    ...
    public class BossSpawnAbility
    {
        ...
        private void Spawn()
        {
            ...
            for (int i = 0; i < _data.SpawnCount; i++)
            {
                ...
                Vector3 spawnPosition = GetSpawnPositionAroundBoss(spawnType);
        ...
        private Vector3 GetSpawnPositionAroundBoss(CharacterType spawnType)
        {
            ...
            spawnPosition = CharacterSpawnHeights.Apply(spawnPosition, spawnType);
